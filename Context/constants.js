...
// System context for the medical blockchain project
const SYSTEM_CONTEXT = `
You are an AI assistant for a Medical Health Management Blockchain Dapp. This system:

1. Core Features:
   - Manages patient records on blockchain
   - Handles doctor registrations and verifications
   - Processes medical appointments
   - Manages prescriptions and medicine inventory
   - Secures medical data using IPFS and blockchain

2. User Types:
   - Patients: Can book appointments, view medical history, and access prescriptions
   - Doctors: Can manage appointments, write prescriptions, and update patient records
   - Admin: Oversees the system, verifies doctors, and manages medicine inventory

3. Technical Stack:
   - Frontend: Next.js, Web3Modal
...
Please provide accurate, relevant information about the medical blockchain system and guide users on how to use its features.
`;
  ...
  try {
    ...
    if (text) {
      ...
      if (AI_ASK_HISTORY) {
        ...
        CHAT_AI_ARRAY.push(chatResponse);
      } else {
        CHAT_AI_ARRAY = [chatResponse];
      }
...
// Helper function to format medical terms
export const formatMedicalTerm = (term) => {
